...
RECORDS ORDER order[] = {
{
    ...
    .Date = "2024-11-13",
    .Price = 17.99,
    .ProductID = ID_OF ( product->Name == "Automatic Dog Feeder" ),
    .CustomerID = ID_OF ( customer->FirstName == "Dill" ),
    .BranchID = 0,
    .Status = "Fulfilled",
},
{
    ...
    .Price = 17.99,
    .ProductID = ID_OF ( product->Name == "Automatic Dog Feeder" ),
    .CustomerID = ID_OF ( customer->FirstName == "Dill2" ),
    .BranchID = 0,
    .Status = "Fulfilled",
},
{
    ...
    .Date = "2024-11-13",
    .Price = 17.99,
    .ProductID = ID_OF ( product->Name == "PS5 Controller" ),
    .CustomerID = ID_OF ( customer->FirstName == "Dill2" ),
    .BranchID = 0,
    .Status = "Fulfilled", 
},
